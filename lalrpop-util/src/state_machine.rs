...
pub trait ParserDefinition: Sized {
    ...
    /// The type emitted by the user's tokenizer. Actually, it is an
    /// iterator over `TokenTriple<Self>`.
    ...
    /// ERROR.
    fn action(&self, state: Self::StateIndex, integer: usize) -> Self::Action;
